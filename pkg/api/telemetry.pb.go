...
const file_pkg_api_telemetry_proto_rawDesc = "" +
	...
	"\tTelemetry\x122\n" +
	"\tSendEvent\x12\x11.api.ProcessEvent\x1a\x12.api.EventResponseB\x12Z\x10edr-core/pkg/apib\x06proto3"
...
var file_pkg_api_telemetry_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_pkg_api_telemetry_proto_depIdxs = []int32{
	...
	1, // 1: api.Telemetry.SendEvent:output_type -> api.EventResponse
